...
class CompanyGeocoder:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CompanyGeocoder_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Company Geocoder')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CompanyGeocoder', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/company_geocoder/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Company Geocoder'),
            callback=self.run,
